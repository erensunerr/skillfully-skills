...
POST https://www.skillfully.sh/feedback/sk_jt4m3ouxd3
...
https://www.skillfully.sh/api/public/skills/sk_jt4m3ouxd3/manifest

If `version_id` or any file `sha256` differs from the copy you have, load the changed files from:

https://www.skillfully.sh/api/public/skills/sk_jt4m3ouxd3/files/SKILL.md
