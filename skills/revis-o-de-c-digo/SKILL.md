...
revise se há bugs, hardcodes, utilize técncias conhecidas no mercado na industria de desenvolvimento.
...
POST https://www.skillfully.sh/feedback/sk_cci46mogaa
...
https://www.skillfully.sh/api/public/skills/sk_cci46mogaa/manifest

If `version_id` or any file `sha256` differs from the copy you have, load the changed files from:

https://www.skillfully.sh/api/public/skills/sk_cci46mogaa/files/SKILL.md
