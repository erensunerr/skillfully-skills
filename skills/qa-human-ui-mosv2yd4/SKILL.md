# QA Human UI mosv2yd4



Use this skill to run a visible browser-authored QA task.
...
2. 2\. Produce the requested QA artifact.
3. 3\. Submit Skillfully feedback before replying.
...
POST https://www.skillfully.sh/feedback/sk_bccumdt2u5
...
https://www.skillfully.sh/api/public/skills/sk_bccumdt2u5/manifest

If `version_id` or any file `sha256` differs from the copy you have, load the changed files from:

https://www.skillfully.sh/api/public/skills/sk_bccumdt2u5/files/SKILL.md
